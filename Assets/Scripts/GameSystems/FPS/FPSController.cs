...
public class FPSController : MonoBehaviour
{
    ...
    [SerializeField] private WeaponSwaySettingData weaponSwaySettingData;
    ...
    [FormerlySerializedAs("isInitilized")] [SerializeField] private bool isInitialized=false;
    ...
    private Vector3 HandleMovement()
    {
        ...
        float currentSpeed = isCrouching ? playerSettingData.crouchSpeed : (Input.GetKey(KeyCode.LeftShift) ? playerSettingData.runSpeed : playerSettingData.speed);
    ...
    private void HandleWeaponSway()
    {
        ...
        var movementX = -Input.GetAxis("Mouse X") * weaponSwaySettingData.swayAmount;
        var movementY = -Input.GetAxis("Mouse Y") * weaponSwaySettingData.swayAmount;
        movementX = Mathf.Clamp(movementX, -weaponSwaySettingData.maxSwayAmount, weaponSwaySettingData.maxSwayAmount);
        movementY = Mathf.Clamp(movementY, -weaponSwaySettingData.maxSwayAmount, weaponSwaySettingData.maxSwayAmount);

        Vector3 finalPosition = new Vector3(movementX, movementY, 0);
        weapon.localPosition = Vector3.Lerp(weapon.localPosition, initialWeaponPosition + finalPosition, Time.deltaTime * weaponSwaySettingData.swaySmoothValue);
    }
